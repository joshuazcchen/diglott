...
public class LanguageCodes {
    public static final Map<String, String> LANGUAGES = new LinkedHashMap<>() {{
        ...
        if (!(ConfigDataRetriever.get("azure_api_key").equals("none"))) {
            ...
            put("(Azure) Mongolian (Cyrillic) TODO", "mn-Cyrl");
            put("(Azure) Mongolian (Traditional) TODO", "mn-Mong");
            ...
            put("(Azure) Klingon (Latin) TODO", "tlh-Latn");
            put("(Azure) Klingon (pIqaD) TODO", "tlh-Piqd");
    ...
    public static final Map<String, String> REVERSELANGUAGES = new LinkedHashMap<>() {{
        ...
        if (!(ConfigDataRetriever.get("azure_api_key").equals("none"))) {
            ...
            put("mn-Cyrl", "(Azure) Mongolian (Cyrillic) TODO");
            put("mn-Mong", "(Azure) Mongolian (Traditional) TODO");
            ...
            put("tlh-Latn", "(Azure) Klingon (Latin) TODO");
            put("tlh-Piqd", "(Azure) Klingon (pIqaD) TODO");
